...
module tip_jar::tip_jar_tests {
    ...
    fun test_same_tipper_multiple_times() {
        ...
        test_scenario::next_tx(&mut scenario, TIPPER_1);
        {
            ...
            tip_jar::send_tip(&mut tip_jar, tip_coin1, ctx);
            
            assert!(tip_jar::get_total_tips(&tip_jar) == 100_000_000, 0);
            assert!(tip_jar::get_tip_count(&tip_jar) == 1, 1);
        ...
        test_scenario::next_tx(&mut scenario, TIPPER_1);
        {
            ...
            tip_jar::send_tip(&mut tip_jar, tip_coin2, ctx);
            
            assert!(tip_jar::get_total_tips(&tip_jar) == 300_000_000, 0);
            assert!(tip_jar::get_tip_count(&tip_jar) == 2, 1);
    ...
    fun test_zero_tip_fails() {
        ...
        test_scenario::next_tx(&mut scenario, TIPPER_1);
        {
            ...
            tip_jar::send_tip(&mut tip_jar, zero_coin, ctx); // Should abort
    ...
    fun test_large_tip_amounts() {
        ...
        test_scenario::next_tx(&mut scenario, TIPPER_1);
        {
            ...
            tip_jar::send_tip(&mut tip_jar, large_tip, ctx);
            
            assert!(tip_jar::get_total_tips(&tip_jar) == 1000_000_000_000, 0);
            assert!(tip_jar::get_tip_count(&tip_jar) == 1, 1);
    ...
    fun test_minimal_tip_amount() {
        ...
        test_scenario::next_tx(&mut scenario, TIPPER_1);
        {
            ...
            tip_jar::send_tip(&mut tip_jar, minimal_tip, ctx);
            
            assert!(tip_jar::get_total_tips(&tip_jar) == 1, 0);
            assert!(tip_jar::get_tip_count(&tip_jar) == 1, 1);
