...
export function TipJar({ refreshKey = 0, onTipSuccess }: TipJarProps) {
  ...
  const sendTip = async () => {
    ...
    try {
      ...
      tx.moveCall({
        target: `${PACKAGE_ID}::tip_jar::send_tip`,
        arguments: [
    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          className="w-full bg-purple-500 text-white py-2 px-4 rounded-md hover:bg-purple-600 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
        >
