...
### Home Page
![Frontend Preview](tip_jar_dapp/assets/1_frontend_preview.png)

### Sending a Tip
![Send Tip](tip_jar_dapp/assets/2_sending_tip.png)

### Confirmation Message
![Send Tip](tip_jar_dapp/assets/3_confirmation_message.png)

### Tip Stats
![Tip Stats](tip_jar_dapp/assets/4_confirmed_tips_number.png)
...
```
tip_jar/
├── tip_jar/                       # Move smart contract
│   ├── Move.toml                  # Contract configuration
│   ├── sources/
│   │   └── tip_jar.move           # Main contract implementation
│   └── tests/
│       └── tip_jar_tests.move     # Comprehensive test suite
